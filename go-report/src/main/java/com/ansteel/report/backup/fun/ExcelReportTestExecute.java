...
public class ExcelReportTestExecute  extends AbstractExecuteXml implements IExecuteXml{

	@Override
	public Class getClazz() {
		return ExcelReportTest.class;
	}

	@Override
	public void importSave(Map<Class, Object> xmlMap, Object o, int type) {
		
		List<ExcelReportTest> xmlEntityList = (List<ExcelReportTest>) o;
	...
	private void save(Map<String, ExcelReport> parentDataBase, List<ExcelReportTest> xmlEntityList) {

		for (ExcelReportTest entity : xmlEntityList) {
			ExcelReportTest xmlEntity =new ExcelReportTest();
			try {
			...
			if(parentDataBase.containsKey(xmlParentId)){
				...
				Collection<ExcelReportTest> dataBaseEntityList = parentDataBaseEntity.getExcelReportTestList();
				String xmlName = xmlEntity.getName();
				
				for (ExcelReportTest dataBaseEntity : dataBaseEntityList) {						
	...
	private ExcelReportTest getUpdateEntity(ExcelReportTest databaseEntity, ExcelReportTest entity) {
