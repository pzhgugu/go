...
public class DataCollectionSQLExecute extends AbstractExecuteXml implements IExecuteXml{

	@Override
	public Class getClazz() {
		return DataCollectionSQL.class;
	}
	...
	public void importSave(Map<Class, Object> xmlMap, Object o, int type) {
		...
		List<DataCollectionSQL> xmlEntityList = (List<DataCollectionSQL>) o;
	...
	private void save(Map<String, DataCollection> parentDataBase, List<DataCollectionSQL> xmlEntityList) {

		for (DataCollectionSQL entity : xmlEntityList) {
			DataCollectionSQL xmlEntity =new DataCollectionSQL();
			try {
			...
			if(parentDataBase.containsKey(xmlParentId)){
				...
				Collection<DataCollectionSQL> dataBaseEntityList = parentDataBaseEntity.getDataCollectionSQLList();
				String xmlName = xmlEntity.getName();
				
				for (DataCollectionSQL dataBaseEntity : dataBaseEntityList) {
	...
	private DataCollectionSQL getUpdateEntity(DataCollectionSQL databaseEntity, DataCollectionSQL entity) {
