...
$(window).resize(function() { 
	...
	GPW.layout.tabbarLayout.setHeight(300);
...
GPW.layout = {
	...
	init : function() {
		...
		this.mainGridLayout.setText("主表");
	...
	maximized:function(is){
		if(is){
			this.treeLayout.expand();
			this.mainGridLayout.expand();
		}else{
			this.treeLayout.collapse();
			this.mainGridLayout.collapse();
		}
	}
}
