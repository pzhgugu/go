...
var GPC = {
	url:{
		...
		detailQueryUrl:GLOBAL.S.URL+GLOBAL.P.MODULES+"/tpl/DetailQuery/"+GLOBAL.P.CLASSNAME+"?"+GLOBAL.P.parameter,
		updateUrl:GLOBAL.S.URL+GLOBAL.P.MODULES+"/a/updateAll/"+GLOBAL.P.CLASSNAME+"?"+GLOBAL.P.parameter+"&format=xml",		
