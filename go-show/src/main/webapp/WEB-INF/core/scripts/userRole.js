...
var GPC = {
	url:{
		refreshGridUrl:GLOBAL.S.URL+GLOBAL.P.MODULES+"/a/userLoadRole?_value="+GLOBAL.P.value,
		queryUrl:GLOBAL.S.URL+GLOBAL.P.MODULES+"/a/userQueryRole?_value="+GLOBAL.P.value,
		updateUrl:GLOBAL.S.URL+GLOBAL.P.MODULES+"/a/updateUserRoles/Roles?format=xml&_value="+GLOBAL.P.value
	},
...
GPW.grid = {
	...
	init : function() {
		...
		this.mainGrid.setHeader("编码,名称,授权");
		this.mainGrid.setColumnIds("name,alias,accredit");
		this.mainGrid.setInitWidths("100,100,100");
		this.mainGrid.setColAlign("left,left,left");
		this.mainGrid.setColTypes("ro,ro,acheck");
		this.mainGrid.setColSorting("str,str,str");
		GLOBAL.initGridCombo(this.mainGrid,{"accredit":[{"text":"是","value":"1"},{"text":"否","value":"0"}]});
