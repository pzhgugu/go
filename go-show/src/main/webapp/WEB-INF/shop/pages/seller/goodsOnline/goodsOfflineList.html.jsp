...
<div class="ncsc-layout wrapper">
    ...
    <div class="ncsc-layout-right" id="layoutRight">
        ...
        <div id="mainContent" class="main-content">
            ...
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="active"><a href="${S_URL}/se/goodsonline/list?goodsState=0">仓库中的商品</a></li>
...
<c:if test="${fn:length(P_GOODS_LIST)>0}">
                <tr>
                    ...
                    <td colspan="20">
                        ...
                        <a name="commonid" uri="se/goodsonline/show?for=xml"
                           nc_type="batchbutton" class="ncsc-btn-mini" href="javascript:void(0);">
       ...
       <td class="goods-time">
           <a class="ncsc-btn" onclick="ajax_get_confirm('','se/goodsonline/show?commonid=${goods.id}')" href="javascript:void(0)">上架</a>
       </td>
       <td>
        <span>
              ...
              <p>
                ...
                <tr>
                    ...
                    <th colspan="10">
                        ...
                        <a class="ncsc-btn-mini" name="commonid" uri="se/goodsonline/show?for=xml"
                           nc_type="batchbutton" href="javascript:void(0);">
                            <i class="icon-level-down">
                            </i>
                            上架
                ...
                <tr>
                    <td colspan="20">
                        <fis:block url="shop:widget/tpl/pagination.html.jsp" >
                            ...
                            <fis:param name="url" value="${S_URL}/se/goodsonline/list?goodsState=0"/>
                        </fis:block>
                    </td>
                </tr>
                </tfoot>
