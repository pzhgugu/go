...
dhtmlXTreeObject.prototype.addPath = function(b, e, c, h) {
    ...
    while (a != g) {
        d.push({
            ...
            to: (g ? g.id: null),
            style: "border-left:" + (c.width || 1) + "px " + (c.mode || "solid") + " " + (c.color || "red") + "; border-bottom:" + (c.width || 1) + "px " + (c.mode || "solid") + " " + (c.color || "red") + ";"
        });
        g = f;
        f = f.parentObject
    }
...
dhtmlXTreeObject.prototype.activatePaths = function(a) {
    ...
    function() {
        ...
        for (var e = 0; e < g.length; e++) {
            ...
            this.addPath(h.parentNode.getAttribute("id"), c.getAttribute("id"), {
                color: h.getAttribute("color"),
                mode: h.getAttribute("mode"),
...
dhtmlXGridObject.prototype._renderPivot = function() {
    ...
    this._pgrid.attachEvent("onBeforeSelect",
    function() {
        return false
    });
    if (this._pivotS.x) {
...
function eXcell_cor(a) {
    ...
    this.edit = function() {
        ...
        this.obj.onclick = function(g) { (g || event).cancelBubble = true
        };
...
function eXcell_wbut(a) {
    ...
    this.edit = function() {
        ...
        this.obj.wrap = "soft";
        this.obj.style.textAlign = this.cell.align;
        this.obj.onclick = function(i) { (i || event).cancelBubble = true
        };
        this.cell.innerHTML = "";
        this.cell.appendChild(this.obj);
...
function eXcell_passw(a) {
    ...
    this.edit = function() {
        ...
        this.obj.wrap = "soft";
        this.obj.style.textAlign = this.cell.align;
        this.obj.onclick = function(b) { (b || event).cancelBubble = true
        };
        this.obj.onmousedown = function(b) { (b || event).cancelBubble = true
        };
...
function eXcell_list(a) {
    ...
    this.edit = function() {
        ...
        this.obj.onclick = function(f) { (f || event).cancelBubble = true
        };
        this.obj.onmousedown = function(f) { (f || event).cancelBubble = true
        };
