...
dhtmlXForm.prototype.items.inputTree = {
	...
	_doAddInput : function(item, data, el, type, pos, dim, css) {
		...
		tree.setImagePath("static/js/dhtmlxSuite/imgs/dhxtree_skyblue/");
		...
		if (typeof (data.form) == "string"){
			...
			images.innerHTML = "&nbsp;<a id='"+menuBtn+"' href='#' onclick="+fName+"><img src='static/images/contentDrop.gif'  style='margin-top: 3px;'/></a>";
