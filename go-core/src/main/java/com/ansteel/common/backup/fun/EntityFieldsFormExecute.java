...
public class EntityFieldsFormExecute extends AbstractExecuteXml implements IExecuteXml{

	@Override
	public Class getClazz() {
		return EntityFieldsForm.class;
	}
	...
	public void importSave(Map<Class, Object> xmlMap, Object o, int type) {
		...
		List<EntityFieldsForm> xmlEntityList = (List<EntityFieldsForm>) o;
	...
	private void save(Map<String, EntityFieldsCategory> parentDataBase, List<EntityFieldsForm> xmlEntityList) {

		for (EntityFieldsForm entity : xmlEntityList) {
			EntityFieldsForm xmlEntity =new EntityFieldsForm();
			try {
			...
			if(parentDataBase.containsKey(xmlParentId)){
				...
				Collection<EntityFieldsForm> dataBaseEntityList = parentDataBaseEntity.getFieldsForm();
				String xmlName = xmlEntity.getName();
				
				for (EntityFieldsForm dataBaseEntity : dataBaseEntityList) {						
	...
	private EntityFieldsForm getUpdateEntity(EntityFieldsForm databaseEntity, EntityFieldsForm entity) {
