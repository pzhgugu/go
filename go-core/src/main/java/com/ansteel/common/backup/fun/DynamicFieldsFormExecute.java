...
public class DynamicFieldsFormExecute extends AbstractExecuteXml implements IExecuteXml{

	@Override
	public Class getClazz() {
		return DynamicFieldsForm.class;
	}
	...
	public void importSave(Map<Class, Object> xmlMap, Object o, int type) {
		...
		List<DynamicFieldsForm> xmlEntityList = (List<DynamicFieldsForm>) o;
	...
	private void save(Map<String, DynamicFieldsCategory> parentDataBase, List<DynamicFieldsForm> xmlEntityList) {

		for (DynamicFieldsForm entity : xmlEntityList) {
			DynamicFieldsForm xmlEntity =new DynamicFieldsForm();
			try {
			...
			if(parentDataBase.containsKey(xmlParentId)){
				...
				Collection<DynamicFieldsForm> dataBaseEntityList = parentDataBaseEntity.getFieldsForm();
				String xmlName = xmlEntity.getName();
				
				for (DynamicFieldsForm dataBaseEntity : dataBaseEntityList) {						
	...
	private DynamicFieldsForm getUpdateEntity(DynamicFieldsForm databaseEntity, DynamicFieldsForm entity) {
