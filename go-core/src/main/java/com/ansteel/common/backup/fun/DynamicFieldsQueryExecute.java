...
public class DynamicFieldsQueryExecute  extends AbstractExecuteXml implements IExecuteXml{

	@Override
	public Class getClazz() {
		return DynamicFieldsQuery.class;
	}
	...
	public void importSave(Map<Class, Object> xmlMap, Object o, int type) {
		...
		List<DynamicFieldsQuery> xmlEntityList = (List<DynamicFieldsQuery>) o;
	...
	private void save(Map<String, DynamicFieldsCategory> parentDataBase, List<DynamicFieldsQuery> xmlEntityList) {

		for (DynamicFieldsQuery entity : xmlEntityList) {
			DynamicFieldsQuery xmlEntity =new DynamicFieldsQuery();
			try {
			...
			if(parentDataBase.containsKey(xmlParentId)){
				...
				Collection<DynamicFieldsQuery> dataBaseEntityList = parentDataBaseEntity.getFieldsQuery();
				String xmlName = xmlEntity.getName();
				
				for (DynamicFieldsQuery dataBaseEntity : dataBaseEntityList) {						
	...
	private DynamicFieldsQuery getUpdateEntity(DynamicFieldsQuery databaseEntity, DynamicFieldsQuery entity) {
