 ...
 * 描   述： 一个工具类，作为查询条件。  
 */
public class GtPropCriterion implements QueryCriterion {
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof GtPropCriterion))
			return false;
		GtPropCriterion castOther = (GtPropCriterion) other;
	...
	public String getCriterionName() {
		return QueryCriterion.TYPE_GT_PROP;
	}

	@Override
	public String getExpre() {
		return PREFIX + getPropName1() + " > " + PREFIX + getPropName2();
	}
